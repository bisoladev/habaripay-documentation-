...
import PaymentImg from '@site/static/img/squad-fav.svg';

# Dynamic Virtual Account V2

This module contains APIs that allow you generate Virtual Accounts that can be used on a transaction basis. This means that you can set a timer for expiry, a transaction ref, determine the amount to be collected. 
...
<button href="#" className="group w-full bg-transparent border border-solid border-gray-200 flex p-5 rounded hover:shadow-sm hover:cursor-pointer">
<a className="flex">
<div>
    <img src={PaymentImg} alt="Squad logo" />
</div>
<div className="pl-4 text-gray-950 dark:text-white">
    <p className="p-0 m-0 hover:text-sm group-hover:text-blue-600">API Specifications</p>
    <p className="pt-1 m-0">Virtual Accounts</p>
</div>
</a>
</button>

<p className="text-center text-gray-400 pt-1 text-sm">Click to Open Link</p>
